        ...
        <div class="card-body">
          ...
          <form action="{{ route('add_company') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="title" value="{{ old('title') }}" class="form-control" id="bs-validation-name" placeholder="company title" required="">
              <div class="valid-feedback"> Looks good! </div>
              <div class="invalid-feedback"> Please Fill company title </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <textarea name="description" value="{{ old('description') }}" class="form-control" id="bs-validation-bio" name="bs-validation-bio" rows="3" ></textarea>
            </div>
            <div class="mb-3">
              <label class="switch switch-primary">
                <input type="checkbox" name="is_active" checked class="switch-input" required="">
