                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <select name="nature" id="nature"
                                ...
                                <option @if (old('nature')==="Full-Time") selected @endif value="Full-Time">Full Time</option>
                                <option @if (old('nature')==="Part-Time") selected @endif value="Part-Time">Part Time</option>
                            </select>
                            @error('nature')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                            ...
                            <select name="company" id="company"
                                ...
                                @if ($companies->count())
                                    @foreach ($companies as $company)
                                        <option @if (old('company')===$company->id) selected @endif value="{{ $company->id }}">{{ $company->title }}</option>
                                    @endforeach
                                @endif
                            </select>
                            @error('company')
                            ...
                            <select name="city" id="city"
                                ...
                                @if ($cities->count())
                                    @foreach ($cities as $city)
                                        <option @if (old('city')===$city->id) selected @endif value="{{ $city->id }}">{{ $city->title }}</option>
                                    @endforeach
                                @endif
                            </select>
                            @error('city')
