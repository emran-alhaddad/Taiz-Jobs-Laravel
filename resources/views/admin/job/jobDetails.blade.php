...
@section('adminContent')
    <div class="d-flex flex-row justify-content-end mb-3">
        ...
        <a class="btn btn-label-danger me-1 collapsed" data-bs-toggle="collapse" href="#deleteJob" role="button"
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('edit_job', $job->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
