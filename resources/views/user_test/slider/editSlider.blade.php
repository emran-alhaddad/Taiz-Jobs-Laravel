...
@section('adminContent')
    ...
    <div class="row {{ !$slider->is_active?"alert-danger":"" }}">
        <div class="col-4 d-flex flex-column justify-content-center align-items-center">
            <img src="{{ asset("uploads/sliders")."/".$slider->image}}" class="img-fluid" alt="">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('edit_slider',$slider->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" value="{{ $slider->title }}" placeholder="slider title"
